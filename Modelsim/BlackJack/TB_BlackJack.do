...
add wave -noupdate -radix binary /TB_BlackJack/DUV/inclk0
add wave -noupdate -radix binary /TB_BlackJack/DUV/clk_PLL
add wave -noupdate -radix binary /TB_BlackJack/DUV/i_Reset
add wave -noupdate -radix binary /TB_BlackJack/DUV/i_Hit
add wave -noupdate -radix binary /TB_BlackJack/DUV/i_Stay
add wave -noupdate -divider Outputs
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Win
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Lose
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Tie
add wave -noupdate -divider {Hit or Stay}
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Hit_P
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Hit_D
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Stay_P
add wave -noupdate -radix binary /TB_BlackJack/DUV/o_Stay_D
...
add wave -noupdate -radix binary /TB_BlackJack/DUV/w_ResetDeb
add wave -noupdate -radix binary /TB_BlackJack/DUV/w_ResetPE
add wave -noupdate -radix binary /TB_BlackJack/DUV/w_HitPE
add wave -noupdate -radix binary /TB_BlackJack/DUV/w_StayPE
add wave -noupdate -divider CONTADOR
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/clk_2K
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/i_ActCounter
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/i_RstCounter
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/i_ResetNeg
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/i_ResetDeb
add wave -noupdate -radix unsigned /TB_BlackJack/DUV/b2v_Contador/o_Count
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/o_TwoSec
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_Contador/o_RstOK
...
add wave -noupdate -divider Inputs
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Embaralhador/clk
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Embaralhador/i_ActShuffler
...
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/i_Clk
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/i_Reset
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/i_Stay
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/i_Hit
...
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/vi_TwoSec
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/vi_RstOK
...
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/vi_Shuffled
add wave -noupdate /TB_BlackJack/DUV/b2v_FSM_Global/vo_ActShuffler
add wave -noupdate -divider {Interface com o CardAdder}
add wave -noupdate -radix binary /TB_BlackJack/DUV/b2v_FSM_Global/vi_CardOK
...
WaveRestoreCursors {{Cursor 1} {35146 ns} 0}
...
update
WaveRestoreZoom {32934 ns} {36262 ns}
