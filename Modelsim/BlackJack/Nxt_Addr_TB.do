...
add wave -noupdate -radix unsigned /Nxt_Addr_TB/NA_DUV/Addr_i
add wave -noupdate -radix unsigned /Nxt_Addr_TB/NA_DUV/Count
add wave -noupdate -radix unsigned /Nxt_Addr_TB/NA_DUV/Addr_j
...
WaveRestoreCursors {{Cursor 1} {31800 ns} 0}
...
update
WaveRestoreZoom {31762 ns} {31888 ns}
